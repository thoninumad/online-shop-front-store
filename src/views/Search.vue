<template>
    <v-card>
        <v-toolbar dark color="primary">
            ...
            <v-text-field v-model="keyword" @input="doSearch" hide-details append-icon="mic" flat label="Search"
        ...
        <v-alert :value="items.length==0 && keyword.length>0" color="warning">Sorry, but no results were found</v-alert>
